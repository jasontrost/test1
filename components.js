...
(function () {
    ...
    // ── Smarkets Logo ───────────────────────────
    const logoIMG = `<picture><source srcset="${bp('/Smarkets_logo.webp')}" type="image/webp"><img src="${bp('/Smarkets_logo.png')}" alt="Smarkets" class="nav-logo" width="378" height="84"></picture>`;
    ...
    // ── Shared icon paths ───────────────────────
    // Single source for SVGs reused across the footer (app stores + socials).
    const ICON_PATHS = {
        ...
        googlePlay: 'M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 01-.61-.92V2.734a1 1 0 01.609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-3.199l2.807 1.626a1 1 0 010 1.732l-2.808 1.626L15.206 12l2.492-2.492zM5.864 2.658L16.8 8.99l-2.3 2.3-8.636-8.632z',
    ...
    const icon = (name, size) =>
        `<svg width="${size}" height="${size}" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="${ICON_PATHS[name]}"/></svg>`;

    // ── Footer ──────────────────────────────────
    const footerHTML = `
        <div class="footer-top">
            <a href="${bp('/')}" class="footer-brand" aria-label="Smarkets home">
                <picture><source srcset="${bp('/Smarkets_logo.webp')}" type="image/webp"><img src="${bp('/Smarkets_logo.png')}" alt="Smarkets" class="footer-logo" width="378" height="84"></picture>
            </a>
        ...
        <div class="footer-content">
            <div class="footer-col">
                ...
                <div class="footer-app-links">
                    <div class="footer-app-group">
                        ...
                        <a href="https://apps.apple.com/gb/app/smarkets-betting-exchange/id1155643579" target="_blank" rel="noopener noreferrer" aria-label="Smarkets on the App Store">
                            ${icon('appStore', 16)}
                        </a>
                        <a href="https://play.google.com/store/apps/details?id=com.smarkets" target="_blank" rel="noopener noreferrer" aria-label="Smarkets on Google Play">
                            ${icon('googlePlay', 16)}
                        </a>
                    </div>
                    <div class="footer-app-group">
                        <span class="footer-app-label">SBK</span>
                        <a href="https://apps.apple.com/gb/app/sbk-sports-betting-online/id1371054563" target="_blank" rel="noopener noreferrer" aria-label="SBK on the App Store">
                            ${icon('appStore', 16)}
                        </a>
                        <a href="https://play.google.com/store/apps/details?id=com.smarkets.sbk" target="_blank" rel="noopener noreferrer" aria-label="SBK on Google Play">
                            ${icon('googlePlay', 16)}
                        </a>
                    </div>
                </div>
            ...
            <div class="footer-col">
                ...
                <div class="social-links">
                    <a href="https://x.com/smarkets" target="_blank" rel="noopener noreferrer" aria-label="Follow Smarkets on X (formerly Twitter)">
                        ${icon('x', 20)}
                        <span class="sr-only">X / Twitter</span>
                    </a>
                    <a href="https://linkedin.com/company/smarkets" target="_blank" rel="noopener noreferrer" aria-label="Follow Smarkets on LinkedIn">
                        ${icon('linkedin', 20)}
                        <span class="sr-only">LinkedIn</span>
                    </a>
                    <a href="https://www.facebook.com/smarkets" target="_blank" rel="noopener noreferrer" aria-label="Follow Smarkets on Facebook">
                        ${icon('facebook', 20)}
                        <span class="sr-only">Facebook</span>
                    </a>
                    <a href="https://instagram.com/smarkets" target="_blank" rel="noopener noreferrer" aria-label="Follow Smarkets on Instagram">
                        ${icon('instagram', 20)}
                        <span class="sr-only">Instagram</span>
                    </a>
                </div>
                <p class="footer-status-link"><a href="https://x.com/smarketstech" target="_blank" rel="noopener noreferrer" class="accent-link">@smarketstech</a> &mdash; outages &amp; status</p>
                <h4 class="footer-subheading">SBK</h4>
                <div class="social-links">
                    <a href="https://twitter.com/sbk" target="_blank" rel="noopener noreferrer" aria-label="Follow SBK on X (formerly Twitter)">
                        ${icon('x', 20)}
                        <span class="sr-only">X / Twitter</span>
                    </a>
                    <a href="https://www.facebook.com/SBK.bet/" target="_blank" rel="noopener noreferrer" aria-label="Follow SBK on Facebook">
                        ${icon('facebook', 20)}
                        <span class="sr-only">Facebook</span>
                    </a>
                    <a href="https://www.instagram.com/sbkapp/" target="_blank" rel="noopener noreferrer" aria-label="Follow SBK on Instagram">
                        ${icon('instagram', 20)}
                        <span class="sr-only">Instagram</span>
                    </a>
                </div>
